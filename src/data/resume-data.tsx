...
export const RESUME_DATA = {
  ...
  summary:
    "Studying CS and Math @ Dartmouth College. Interested in product design, machine learning, and backend eng. I love shipping fast and building meaningful, useful solutions to interesting problems. I like spending my time tinkering with SOTA tech and reading papers.\nCurrently building something cool in computer vision + sports :)",
